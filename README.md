To open the web app, after you have downloaded the required packages from requirements.txt, firstly run the database.py file which will create a compatible database from the imdb csv file.
